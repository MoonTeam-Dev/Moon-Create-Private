...
module.exports = (client, guild) => {
    ...
    if (channel.permissionsFor(guild.me).has("EMBED_LINKS")) {
        channel.send({
            embeds: [
                new Discord.MessageEmbed()
                    ...
                    .addField(`\`${config.prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/Hwx83k9QTT) of the Bot!*", true)
                    ...
                    .addField(`\`${config.prefix}tutorial\``, "> *Gives you a Link to the [GitHub](https://github.com/MoonTeam-Dev)*", true)
                    .addField(`\`${config.prefix}source\``, "> *Gives you a Link to the [Source Code on Github](https://github.com/MoonTeam-Dev)*", true)
                    .addField("\u200b", "\u200b")
        ...
        channel.send("**Here is a GitHub:**\nhttps://github.com/MoonTeam-Dev")
    } else {
