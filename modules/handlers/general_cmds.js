    ...
    message.reply({
      embeds: [
        new Discord.MessageEmbed()
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setAuthor(`${client.user.username} Support`, client.user.displayAvatarURL(), "https://github.com/MoonTeam-Dev")
          .setDescription("[\`Join to Support Server\`](https://discord.gg/Hwx83k9QTT) to gain help! OR watch the [GitHub](https://github.com/MoonTeam-Dev)")
      ]
    })
    return;
    ...
    message.reply({
      embeds: [
        new Discord.MessageEmbed()
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setAuthor(`${client.user.username}'s' Source Code`, client.user.displayAvatarURL(), "https://github.com/MoonTeam-Dev")
          .setTitle(`This Bot is made by \`Moon Team 🌙\` and **this** is the Source Code link to this Bot`)
          .setURL("https://github.com/MoonTeam-Dev")
          ...
          .addField("Source Code. ", "Don't just use the source for yourself,... please [invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) me too![\`Click here\`](https://github.com/MoonTeam-Dev)")
