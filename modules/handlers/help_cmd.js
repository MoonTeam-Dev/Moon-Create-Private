  ...
  if (!args[0])
    return message.reply({
      embeds: [new Discord.MessageEmbed()
        ...
        .setDescription(`PREFIX: \`${prefix}\` | [Click here - GitHub](https://github.com/MoonTeam-Dev)\n\n*Enter the right Category, to see help for them* Example: \`${prefix}help voice\`\n[\`INVITE ME\`](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot) | [\`Support Server\`](https://discord.gg/Hwx83k9QTT) | [\`Website\`](https://github.com/MoonTeam-Dev) | Developer: \`Moon Team 🌙\``)
    ...
    case "general": {
      return message.reply({
        embeds: [new Discord.MessageEmbed()
          ...
          .addField(`\`${prefix}support\``, "> *Sends you a Link for the [SUPPORT SERVER](https://discord.gg/Hwx83k9QTT) of the Bot!*", true)
          ...
          .addField(`\`${prefix}tutorial\``, "> *Gives you a Link to the [GitHub](https://github.com/MoonTeam-Dev)*", true)
          .addField(`\`${prefix}source\``, "> *Gives you a Link to the [Source Code on Github](https://github.com/MoonTeam-Dev)*", true)
